...
<div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
    ...
    <div class="sidebar-menu-content">
        <ul class="nav nav-sidebar-menu sidebar-toggle-view">
            ...
            <li class="nav-item">
                <a href="dashboard.php" class="nav-link"><i class="icon-sidebar fas fa-tachometer-alt"></i><span>Tableau
                        de
                        bord</span></a>
            </li>
            <!-- <li class="nav-item">
                <a href="ajouter-des-ecoles.php" class="sub-group-active nav-link"><i class="flaticon-dashboard"></i><span>Créer une
                        école</span></a>
            </li> -->
            <!-- <li class="nav-item sidebar-nav-item">
                <a href="#" class="nav-link"><i class="flaticon-mortarboard"></i><span>Ecole</span></a>
                <ul class="nav sub-group-menu">
                    <li class="nav-item">
                        <a href="list-ecole.php" class="nav-link"><i class="fas fa-angle-right"></i>Mes écoles</a>
                    </li>
                    <li class="nav-item">
                        <a href="mykelasi-school.php" class="nav-link"><i class="fas fa-angle-right"></i>Créer une
                            école</a>
                    </li> 
                </ul>
            </li> -->
            <li class="nav-item">
                <a href="all-school.php" class="nav-link"><i
                        class="icon-sidebar fas fa-home"></i></i><span>Ecoles</span></a>
            </li>
            <li class="nav-item">
                <a href="finance.php" class="nav-link"><i class="icon-sidebar fas fa-coins"></i><span>Finance</span></a>
            </li>
            <li class="nav-item">
                <a href="profil.php" class="nav-link"><i class="icon-sidebar fas fa-user-circle"></i><span>Mon profil</span></a>
            </li>
            <li class="nav-item">
                <a href="../login/logout.php" class="nav-link"><i
                        class="icon-sidebar fas fa-sign-out-alt"></i><span>Déconnexion</span></a>
            </li>
            <!--<li class="nav-item sidebar-nav-item">
