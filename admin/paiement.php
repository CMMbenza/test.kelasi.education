...
function fetchRows(PDO $pdo, string $statut, string $codeEcole): array
{
    $sql = "
    SELECT
        p.id,
...
$rowsInscription = fetchRows($pdo, 'Inscription', $codeEcole);
$rowsMinerval    = fetchRows($pdo, 'Minerval', $codeEcole);
$rowsAutres      = fetchRows($pdo, 'Autre', $codeEcole);
...
<body>
            ...
            <div class="dashboard-content-one">
                <div class="row mt-3">
                    <div class="card ui-tab-card w-100">
                        <div class="card-body">
                            <h3>Finances - Paiement du jour</h3>
                            ...
                            <div class="icon-tab">
                                <ul class="nav nav-tabs d-flex align-items-center" role="tablist">
                                    ...
                                    <li class="ml-auto d-flex">
                                        ...
                                        <a class="btn btn-dark mr-2 btn-lg" href="paiement_scolaire.php">
                                            <i class="fas fa-sliders-h"></i> Effectué le paiement
                                        </a>
                                    ...
                                    <div class="tab-pane fade show active" id="tabInscription" role="tabpanel">
                                        <div class="col-12-xxxl col-12">
                                            <div class="heading-layout1">
                                                ...
                                                <a class="btn btn-success btn-lg" href="paiement_history.php">
                                                ...
                                                <table class="table display data-table text-nowrap">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Nom</th>
                                                            <th>Classe</th>
                                                            <th class="text-dange">A payer</th>
                                                            <th>Payé</th>
                                                            <th>Solde(Reste)</th>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-dange">
                                                                <?= money($r['montant_a_payer'] ?? null) ?></td>
                                                            <td><?= money($r['montant_paye'] ?? null) ?></td>
                                                            <td class="text-danger"><?= money($r['solde'] ?? null) ?>
                                                            </td>
                                                            <td><?= h($r['date_paiement'] ?? '—') ?></td>
                                                            <td class="text-center">
                                                                <button class="btn btn-danger btn-print"
    ...
    $('.btn-print').on('click', function() {
        ...
        let paiement = $(this).data('paiement');
        ...
        $('#recuContent').load(
            'service/recu_ajax.php?paiement_id=' + paiement
        );
